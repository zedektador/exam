...
$app->middleware([
   App\Version1\Http\Middleware\LanguageMiddleware::class
]);
...
$app->register(App\Version1\AppServiceProvider::class);
/*
  |--------------------------------------------------------------------------
...
$app->router->group([
    ...
    require __DIR__ . '/../routes/webv1.php';
});

$app->router->group([
    'namespace' => 'App\Version2\Http\Controllers',
        ], function ($router) {
    require __DIR__ . '/../routes/webv2.php';
});
